...
```r
fisheries_tidy %>% 
count(n_countries=n_distinct(country))
```
...
## 1      1551
```
There are 1551 distinct species caught as part of the data for asfis_species_number. 
...
fisheries_tidy %>%
  ...
  summarize(sardines_catch=sum(catch, na.rm=T)) %>%
...
## 1 Morocco           7470
```
Morocco caught the most sardines (7470) between the years 1990 and 2000. 
...
```
Theragra chalcogramma is the species that had the highest catch total between 2008 and 2012. 

10. Use the data to do at least one analysis of your choice.
Question: What is the average amount of fish that China caught each year from 2000 to 2012?

```r
fisheries_tidy %>%
  filter(country=="China", between(year, 2000, 2012)) %>% 
...
## 1       254.
```
China caught an average of 253 fish per year from 2000 to 2012. 
