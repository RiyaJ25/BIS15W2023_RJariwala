...
3. How do you interpret this result? What does this mean about NAs? The data is missing, so you need to run additional code to find out where it is.   

4. Recalculate the mean using the following code chunk. Why is the useful? Because it allows you to calculate the mean of the vector even though there is missing data. 
```{r}
