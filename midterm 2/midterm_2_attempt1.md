...
surgery %>% 
  mutate(health_status=case_when(asa_status>=1 | asa_status<=2  ~ "healthy",
                                 asa_status=3 ~ "somewhat_healthy",
                                 asa_status>=4 ~ "unhealthy")) %>% 
...
surgery %>% 
  ...
  summarize(ahrq_ccs, ccsmort30rate) %>% 
...
surgery %>% 
  ...
  summarize(ahrq_ccs, ccscomplicationrate) %>% 
...
##  2 Small bowel resection               0.466
##  3 Small bowel resection               0.466
##  4 Small bowel resection               0.466
##  5 Small bowel resection               0.466
##  6 Small bowel resection               0.466
##  7 Small bowel resection               0.466
##  8 Small bowel resection               0.466
##  9 Small bowel resection               0.466
## 10 Small bowel resection               0.466
## # … with 31,991 more rows
```
...
surgery %>% 
  group_by(month) %>% 
  summarize(month, ccscomplicationrate, mort30)
```
...
## # A tibble: 32,001 × 3
## # Groups:   month [12]
##    month ccscomplicationrate mort30
##    <chr>               <dbl> <chr> 
##  1 Apr                0.0723 No    
##  2 Apr                0.0723 No    
##  3 Apr                0.0723 No    
