...
## [9] "turtles"
```
#The taxa represented in the "homerange" data frame are lake fishes, mammals, river fishes, tortoises, birds, lizards, marine fishes, snakes, and turtles. 
...
##       342       227
```
#There are 342 carnivores and 227 herbivores in the trophic guild. 
...
## [1] 34137012
```
#The herbivores have on average a larger mean.hra.m2 value. 
...
deerlogmass <- deer[order(deer$log10.mass, decreasing = TRUE),] 
filter(deerlogmass, family=="cervidae")
```
...
```r
common_name <- filter(homerange, species=="alces")
common_name
```
...
#The largest deer is _Alces_ _alces_, and this deer has an average mass of 307227.44 grams. The common name of this deer is moose. 


**10. As measured by the data, which snake species has the smallest homerange? Show all of your work, please. Look this species up online and tell me about it!** **Snake is found in taxon column**    

```r
snake <- select(homerange, "taxon", "species", "mean.hra.m2")
snake <- filter(snake, taxon=="snakes")
...
```r
smallest <- filter(snake, mean.hra.m2==200)
smallest
```
...
```
#The bitis schneideri snake species has the smallest homerange of 200 in the data set. This snake species is venomous and commonly found in Namibia and South Africa. It is also the world's smallest viper snake! Source: (Bitis schneideri) [https://en.wikipedia.org/wiki/Bitis_schneideri]
